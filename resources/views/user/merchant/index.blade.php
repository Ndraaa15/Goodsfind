            ...
            <div class="container mt-3">
                <div class="banner">
                    ...
                    <div class="banner-content">
                        ...
                        <a href="#edit-modal" data-toggle="modal" class="btn btn-outline-primary-2 banner-link"><span class="icon-edit">Edit</span></a>
                        <a href="#withdraw-modal" data-toggle="modal" class="btn btn-outline-primary-2 banner-link"><span class="icon-cart-arrow-down">Withdraw</span></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    @else
                        @foreach($products as $product)
                            ...
                            <tr>
                                <td class="product-col">
                                    <div class="product">
                                        <figure class="product-media">
                                            <a href="#">
                                                <img src="{{ $product->image ?: 'assets/images/slide-2.jpg' }}"
                                                     alt="Product image">
                                            </a>
                                        </figure>
                                ...
                                <td class="action-col">
                                    <button href="#update-modal" data-toggle="modal" class="btn btn-outline btn-edit"
                                ...
                                <td class="remove-col">
                                    <form id="delete-product"
                                          action="{{ route('delete-product', ['id' => $product->id])}}" method="POST">
                                        @csrf
                                        @method('DELETE')
                        ...
                        @foreach($orderItems as $orderItem)
                            ...
                            <tr>
                                <td class="product-col">
                                    <div class="product">
                                        <figure class="product-media">
                                            <a href="#">
                                                <img
                                                    src="{{ $orderItem->product->image ?: 'assets/images/slide-2.jpg'}}"
                                                    alt="Product image">
                                            </a>
                                        </figure>
                                        <h3 class="product-title">
                                ...
                                @if($orderItem->status_order == 'Pending')
                                    <td class="action-col">
                                        <button href="#check-modal" data-toggle="modal" class="btn btn-outline"
                                                data-shipping-address-name="{{ $shippingAddress->name }}"
                                                data-shipping-address="{{ $shippingAddress->city }}"
