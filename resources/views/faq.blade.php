...
<main class="main">
    ...
    <div class="page-content">
        <div class="container">
            <h2 class="title text-center mb-3 mt-3">Shipping Information</h2>
    ...
    <div class="cta cta-display bg-image pt-4 pb-4" style="background-image: url({{asset('assets/images/background.jpg') }});">
        <div class="container">
